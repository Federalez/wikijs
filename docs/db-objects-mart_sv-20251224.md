...
published: true
date: 2025-12-24 10:44:16
tags: [database, mart_sv, metadata]
---

# Database Objects - mart_sv

Дата создания: 2025-12-24 10:44:16

Всего уникальных объектов: **358**
...
| audit_cash_balance | BASE TABLE |
| b_sale_del_06 | BASE TABLE |
| branch_attributes_history | BASE TABLE |
| branch_claster | BASE TABLE |
| branch_quant | BASE TABLE |
| branch_square_history | BASE TABLE |
| branch_type | BASE TABLE |
| buh_availab_of_doc | BASE TABLE |
| buh_cloud_sales_registers_errors | BASE TABLE |
| buh_collection_errors | BASE TABLE |
| buh_confirmation_of_costs | BASE TABLE |
| buh_costs_and_debts | BASE TABLE |
| buh_customer_credit_debt | BASE TABLE |
| buh_debts_ok_errors | BASE TABLE |
| buh_exchange_errors | BASE TABLE |
| buh_regist_invoices | BASE TABLE |
| buh_skan_sf_and_edo | BASE TABLE |
| buh_subreport_control | BASE TABLE |
| buh_work_load | BASE TABLE |
| calculation_format_change_history | BASE TABLE |
| cap_quant_lite_all_dns | BASE TABLE |
| category_direct | BASE TABLE |
| comm_activ | BASE TABLE |
| comm_ar_sales | BASE TABLE |
| comm_assessment_shipment | BASE TABLE |
| comm_asset_penalty_calculation | BASE TABLE |
| comm_avg_stoks_history_b_c_w_m | BASE TABLE |
| comm_avg_stoks_unsold_history_b_c_w_m | BASE TABLE |
| comm_branch_rating | BASE TABLE |
| comm_city_category_with_market | BASE TABLE |
| comm_city_rating_raw | BASE TABLE |
| comm_ctm_sales | BASE TABLE |
| comm_current_product_raiting | BASE TABLE |
| comm_current_product_raiting_new | BASE TABLE |
| comm_daily_mart | BASE TABLE |
| comm_delete_shipment | BASE TABLE |
| comm_density | BASE TABLE |
| comm_distr_quant_categories_module | BASE TABLE |
| comm_distr_quant_core | BASE TABLE |
...
| comm_inside_sum_archive | BASE TABLE |
| comm_merchprojects | BASE TABLE |
| comm_midvolga_dyn_d | BASE TABLE |
| comm_mkf_dynamics | BASE TABLE |
| comm_monthly_mart | BASE TABLE |
| comm_potencials_for_sq_calc | BASE TABLE |
| comm_product_zapret_prodazh | BASE TABLE |
| comm_prognozy_prodazh | BASE TABLE |
| comm_retail_month_dynamic_b_c | BASE TABLE |
| comm_retail_week_dynamic_b_c | BASE TABLE |
| comm_revansh | BASE TABLE |
| comm_sales_dyn_b_c_month | BASE TABLE |
| comm_sales_dyn_b_c_week | BASE TABLE |
| comm_sales_dyn_b_c_week_tmp | BASE TABLE |
| comm_shipments_statistik | BASE TABLE |
| comm_showcase | BASE TABLE |
| comm_showcase_capacity_month | BASE TABLE |
| comm_showcase_capacity_week | BASE TABLE |
| comm_showcase_stoks_d | BASE TABLE |
| comm_stocks_density | BASE TABLE |
| comm_thermal_paper | BASE TABLE |
| comm_ugs_sales | BASE TABLE |
| comm_unsold_dyn_month_lezhaki | BASE TABLE |
| comm_unsold_dyn_week_lezhaki | BASE TABLE |
| comm_unsold_dyn_week_potentials | BASE TABLE |
| comm_upstream_pressure_on_rrc | BASE TABLE |
| comm_weekly_mart | BASE TABLE |
| comm_zero_crossing | BASE TABLE |
| current_stock_mvideo | BASE TABLE |
| current_stock_mvideo_to_del | BASE TABLE |
| daily_sales_share | BASE TABLE |
| dict_branch | BASE TABLE |
| dict_category | BASE TABLE |
| dict_dim_branch | BASE TABLE |
| dict_dim_product | BASE TABLE |
| dict_gfk_category | BASE TABLE |
| dict_product | BASE TABLE |
...
| fed_unsold_snapshots | BASE TABLE |
| for_sim_del_06 | BASE TABLE |
| for_sim_sotr_del_06 | BASE TABLE |
| formats_autodistr_log_daily | BASE TABLE |
| formats_transformation_store_calculator | BASE TABLE |
| fpu_del_07_2025 | BASE TABLE |
| gfk_by_category | BASE TABLE |
| gfk_category_rrs | BASE TABLE |
| gfk_from_excel | BASE TABLE |
| gfk_from_excel_new_format | BASE TABLE |
| gfk_from_presentations | BASE TABLE |
| gfk_presentation_september | BASE TABLE |
| hr_sport_event | BASE TABLE |
| hr_sport_event_test | BASE TABLE |
| inside_dict | BASE TABLE |
| kpd_motivation_monitoring_of_staff_workload | BASE TABLE |
| max_fill_quant_history | BASE TABLE |
| midvolga_warehouse_running_stocks | BASE TABLE |
| minus_stock | BASE TABLE |
| minus_stock_history | BASE TABLE |
| minus_stock_history_del_1125 | BASE TABLE |
| nesootvetstviye_ka_rn_op | BASE TABLE |
| nesootvetstviye_ka_rn_op_history | BASE TABLE |
| otgr_priem | BASE TABLE |
| potencial_dec | BASE TABLE |
| price_for_events | BASE TABLE |
| price_for_events_log_from_metabase | BASE TABLE |
| price_for_events_snapshot | BASE TABLE |
| price_for_events_tmp | BASE TABLE |
| price_tag_current | BASE TABLE |
| price_tag_current_old | BASE TABLE |
| price_tag_current_snapshot | BASE TABLE |
| price_tag_custom_user_list | BASE TABLE |
| price_tag_custom_user_list_snapshot | BASE TABLE |
| price_tag_log | BASE TABLE |
| price_tag_settings | BASE TABLE |
| price_tag_stat | BASE TABLE |
| price_tag_unsold_category | BASE TABLE |
| price_tag_unsold_category_old | BASE TABLE |
| price_tag_unsold_current | BASE TABLE |
| price_tag_unsold_current_snapshots | BASE TABLE |
| price_tag_unsold_current_test | BASE TABLE |
| price_tags_email | BASE TABLE |
| prodazhi_fed_lezhakov | BASE TABLE |
| product_fixes_daily | BASE TABLE |
| product_fixes_total | BASE TABLE |
| reason_for_admission | BASE TABLE |
| rekl_clothes_hist | BASE TABLE |
| reserves_discount | BASE TABLE |
| reserves_discount_history | BASE TABLE |
| reserves_movement | BASE TABLE |
| reserves_movement_history | BASE TABLE |
| reserves_rn | BASE TABLE |
| reserves_rn_history | BASE TABLE |
| reserves_tranzit | BASE TABLE |
| reserves_tranzit_history | BASE TABLE |
| rls_access_final | BASE TABLE |
| rls_dict_access | BASE TABLE |
| rls_dict_hand | BASE TABLE |
| rls_dict_sotr | BASE TABLE |
| rp_bank_always_yes | BASE TABLE |
| rp_bank_always_yes_copy | BASE TABLE |
| rp_bank_applications | BASE TABLE |
| rp_bank_poscredit | BASE TABLE |
| rp_metrics_sp | BASE TABLE |
| rp_metrics_sp_div | BASE TABLE |
| rp_postamate_cells_fin | BASE TABLE |
| rp_postamate_cells_raw_data | BASE TABLE |
| rp_postamate_orders | BASE TABLE |
| rp_postamate_prod_category | BASE TABLE |
| rp_postomate_deadcell_hist | BASE TABLE |
| rp_sales | BASE TABLE |
| rp_sales_2 | BASE TABLE |
| rp_sales_log | BASE TABLE |
| rp_staff | BASE TABLE |
| rp_tso_metrics_0_full | BASE TABLE |
| rp_tso_metrics_2_div | BASE TABLE |
| rp_tso_metrics_2_month | BASE TABLE |
| rp_tso_metrics_2_week | BASE TABLE |
| rp_tso_metrics_div | BASE TABLE |
| rp_tso_metrics_month | BASE TABLE |
| rp_tso_metrics_week | BASE TABLE |
| rp_tso_metrics_week_sotr | BASE TABLE |
| rp_weekpricehistory | BASE TABLE |
| rp_weekpricehistory_product | BASE TABLE |
| rrp_from_bot_to_formats | BASE TABLE |
| rs_LokalnyeLezhakiDljaRasprodazhi_snapshot | BASE TABLE |
| rs_lokalnyelezhakidljarasprodazhi_snapshot | BASE TABLE |
| rs_tseny_setkavozmozhnyhznachenij | BASE TABLE |
| sale_sotr | BASE TABLE |
| sales_promosotrudnika | BASE TABLE |
| sales_turnover | BASE TABLE |
| sc_employee | BASE TABLE |
| sc_product_group | BASE TABLE |
| sc_replenishment_marker_hist | BASE TABLE |
| sc_upload_wl_coef | BASE TABLE |
| sell_day | BASE TABLE |
| stm_za_stock_sale_del | BASE TABLE |
| stock_day2 | BASE TABLE |
| stock_hist | BASE TABLE |
| stock_hist_agr | BASE TABLE |
| sv_active_account_stock_b_daily | BASE TABLE |
| sv_active_stock_b_daily | BASE TABLE |
| sv_matrix_analyzer | BASE TABLE |
...
| unclosed_transits | BASE TABLE |
| unclosed_transits_history | BASE TABLE |
...
| hr_employees_count | MATERIALIZED VIEW |
| hr_returning_employees | MATERIALIZED VIEW |
...
| price_tag_event_current_state | MATERIALIZED VIEW |
...
| timedellog | MATERIALIZED VIEW |
| turnrsilog | MATERIALIZED VIEW |
| ur_mat_claim | MATERIALIZED VIEW |
| ur_mat_decisions | MATERIALIZED VIEW |
| comm_potentials_hist_b_c | PARTITIONED TABLE |
| comm_retail_dyn_m | PARTITIONED TABLE |
| comm_retail_dyn_w | PARTITIONED TABLE |
| comm_unsold_history_on_stat | PARTITIONED TABLE |
| rp_sales_0 | PARTITIONED TABLE |
...
| b_sotr | VIEW |
| b_ter | VIEW |
| branch_configuration_model | VIEW |
...
| share_online_orders_on_tso_view | VIEW |
| share_payment_on_tso_view | VIEW |
| share_purchase_on_tso_view | VIEW |
| share_supermarket_on_tso_view | VIEW |
